...
namespace HelloMigraDoc
{
    public class Paragraphs
    {
        ...
        public static void DemonstrateIndent(Document document)
        {
        ...
        public static void DemonstrateFormattedText(Document document)
        {
        ...
        public static void DemonstrateBordersAndShading(Document document)
        {
