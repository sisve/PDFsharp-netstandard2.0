using ProtectedPdf.Helpers;
using System.IO;
using System.Reflection;
using System.Text;

namespace ProtectedPdf
{
    class Program
    {
        static Program()
        ...
        public static void ReadPdf()
        {
            ...
            string filename = "in/TwoPagesOnOne_tempfile.pdf";
            ...
            */
            ...
            // Save the document...
            filename = "out/TwoPagesOnOne_tempfile.pdf";
        ...
        static void WriteTest()
        {
            using (PdfSharp.Pdf.PdfDocument document = new PdfSharp.Pdf.PdfDocument())
            {
                ...
                using (PdfSharp.Drawing.XGraphics gfx = PdfSharp.Drawing.XGraphics.FromPdfPage(page))
                {
                    ...
                    XTextFormatterEx2 etf = new XTextFormatterEx2(gfx);


                    gfx.DrawRectangle(pen, new PdfSharp.Drawing.XRect(100, 100, 100, 100));

                    var workingPath = Directory.GetCurrentDirectory();
                    var pngFilePath = Path.Combine(workingPath, "in/Wikipedesketch1.png");
                    using (var img = PdfSharp.Drawing.XImage.FromFile(pngFilePath))
                    {
                ...
                string filename = "out/pwdprotected-user-owner.pdf";
